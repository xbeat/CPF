...
2. Inserisci il codice indicatore: `X.Y-IT`
3. Clicca su "Load Indicator"
...
Per validare qualsiasi file JSON:
...
Oppure usa il pulsante "Validate JSON" nel client interattivo.
