...
const translations = {
    'en-US': {
        ...
        // Dashboard
        'dashboard.welcome': 'Welcome to CPF Dashboard',
        'dashboard.welcomeMessage': 'You are now logged in. Choose an option below to continue.',
        'dashboard.profile': 'Profile',
        'dashboard.adminPanel': 'Admin Panel',
        'dashboard.logout': 'Logout',
        'dashboard.myProfile': 'My Profile',
        'dashboard.myProfileDesc': 'View and edit your personal information',
        'dashboard.auditing': 'Auditing',
        'dashboard.auditingDesc': 'Access the auditing module (coming soon)',
        ...
        'dashboard.accountExpires': 'Account Expires:',
        ...
        'profile.confirmLogoutAll': 'Are you sure you want to logout from all other devices?',
        'profile.logoutAllSuccess': 'Logged out from all other devices',
        'profile.sessionRevoked': 'Session revoked',
        'profile.sessionsError': 'Failed to load sessions',
    ...
    'it-IT': {
        ...
        // Dashboard
        'dashboard.welcome': 'Benvenuto in CPF Dashboard',
        'dashboard.welcomeMessage': 'Hai effettuato l\'accesso. Scegli un\'opzione qui sotto per continuare.',
        'dashboard.profile': 'Profilo',
        'dashboard.adminPanel': 'Pannello Admin',
        'dashboard.logout': 'Esci',
        'dashboard.myProfile': 'Il Mio Profilo',
        'dashboard.myProfileDesc': 'Visualizza e modifica le tue informazioni personali',
        'dashboard.auditing': 'Auditing',
        'dashboard.auditingDesc': 'Accedi al modulo auditing (in arrivo)',
        'dashboard.comingSoon': 'In Arrivo',
        'dashboard.adminPanelDesc': 'Gestisci utenti e impostazioni di sistema',
        'dashboard.accountInfo': 'Informazioni Account',
        'dashboard.email': 'Email:',
        'dashboard.role': 'Ruolo:',
        'dashboard.lastLogin': 'Ultimo Accesso:',
        'dashboard.accountExpires': 'Scadenza Account:',
        'dashboard.never': 'Mai',
        ...
        'profile.loadingSessions': 'Caricamento sessioni...',
        'profile.noSessions': 'Nessuna sessione attiva',
        'profile.currentSession': 'Corrente',
        'profile.lastActive': 'Ultima attività',
        'profile.revoke': 'Revoca',
        'profile.logoutAll': 'Disconnetti da tutti i dispositivi',
        'profile.confirmLogoutAll': 'Sei sicuro di volerti disconnettere da tutti gli altri dispositivi?',
        'profile.logoutAllSuccess': 'Disconnesso da tutti gli altri dispositivi',
        'profile.sessionRevoked': 'Sessione revocata',
        'profile.sessionsError': 'Impossibile caricare le sessioni',
        ...
        'profile.currentPasswordRequired': 'La password attuale è richiesta',
