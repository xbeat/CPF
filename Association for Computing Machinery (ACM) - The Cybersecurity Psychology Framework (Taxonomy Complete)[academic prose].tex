%%
%% This is file `converted-paper.tex',
%% generated based on the user's request using the provided ACM template.
%%
...
%% These are sample values; adjust as needed.
...
%%
%% Keywords are included in the abstract in the original, but ACM template places them separately.
...
\begin{table*}[t]
\caption{Exemplary Behavioral Risk Indicators (BRIs) with Quantitative Scoring}
\label{tab:bri_examples}
\centering
\begin{tabular}{@{}l l l l@{}}
\toprule
\textbf{BRI Name} & \textbf{Category} & \textbf{Measurement Logic} & \textbf{Scoring} \\
\midrule
Unquestioning Compliance & Authority (1.1) & $\frac{\text{Unverified}}{\text{Total}} \times 100$ & 
\begin{tabular}{@{}l@{}}Green: <5\% \\ Yellow: 5-15\% \\ Red: >15\%\end{tabular} \\
\midrule
Patch Procrastination & Temporal (2.4) & $I_{PP} = \frac{\max(0, D - 30)}{10}$ & 
\begin{tabular}{@{}l@{}}Green: $I_{PP} < 1$ \\ Yellow: $1 \leq I_{PP} < 3$ \\ Red: $I_{PP} \geq 3$\end{tabular} \\
\midrule
Alert Dismissal Rate & Cognitive (5.1) & $\frac{\text{Dismissed}}{\text{Total}} \times 100$ & 
\begin{tabular}{@{}l@{}}Green: <10\% \\ Yellow: 10-25\% \\ Red: >25\%\end{tabular} \\
\bottomrule
\end{tabular}
\end{table*}
