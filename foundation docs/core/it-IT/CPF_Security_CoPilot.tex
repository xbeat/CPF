...
Questo lavoro apporta tre contributi principali:
...
\item Soglie di convergenza che attivano investigazioni profonde quando vulnerabilità multiple si allineano
\end{itemize}
