...
\fancyhead[L]{CPF Linee Guida di Audit}
...
\hypersetup{
    ...
    citecolor=blue,
    urlcolor=blue,
    pdftitle={CPF Linee Guida di Audit v1.0},
    pdfauthor={Giuseppe Canale, CISSP},
}

\title{\textbf{CPF Linee Guida di Audit}\\
\large Version 1.0\\
\large Auditing Sistema di Gestione della Vulnerabilità Psicologicas}
...
The CPF Linee Guida di Audit provide systematic methodology for evaluating organizational conformity to CPF-27001:2025 Sistema di Gestione della Vulnerabilità Psicologica (PVMS) requirements. This document addresses the unique challenges of auditing human factors in cybersecurity while maintaining rigorous privacy protections and ethical standards.
...
\begin{itemize}
\item \textbf{CPF-27001:2025 Requisiti}: Normative standard (Clauses 4-10)
\item \textbf{CPF Modello di Score e Maturità}: Mathematical verification framework
...
\item \textbf{ISO/IEC 27006:2015}: Requisiti for certification bodies
...
\subsection{Unique Competency Requisiti}
...
\textbf{Informed Consent Requisiti:}
...
\subsubsection{Statistical Validity Requisiti}
...
\subsubsection{Evidence Requisiti by Level}
...
\textbf{4.4 Sistema di Gestione della Vulnerabilità Psicologica}
...
\subsubsection{Anonymization Requisiti}
...
\textbf{Core Knowledge Requisiti:}
...
\begin{itemize}
\item \textbf{Certification Body Requisiti}: Impartiality, competence, resources
...
\textbf{CPF Audit Report Requisiti:}
...
\textbf{CPE Requisiti by Certification:}

\begin{table}[h]
\centering
\caption{CPE Requisiti}
\begin{tabular}{lccc}
\toprule
...
\subsection{Aggregation Requisiti}
...
\textbf{Clause:} 6.1.2 Psychological Vulnerability Assessment (Privacy Requisiti)
...
\textbf{PVMS (Sistema di Gestione della Vulnerabilità Psicologica)}: Management system for identifying and mitigating psychological vulnerabilities per CPF-27001.
...
\begin{itemize}
\item Canale, G. (2025). \textit{CPF-27001:2025 Sistema di Gestione della Vulnerabilità Psicologica -- Requisiti}. CPF Foundation.
\item Canale, G. (2025). \textit{CPF Modello di Score e Maturità v1.0}. CPF Foundation.
...
\item ISO/IEC 27006:2015. \textit{Requisiti for bodies providing audit and certification of information security management systems}. International Organization for Standardization.
\item ISO/IEC 27001:2022. \textit{Information security management systems -- Requisiti}. International Organization for Standardization.
\end{itemize}
...
\textit{CPF Linee Guida di Audit v1.0}
