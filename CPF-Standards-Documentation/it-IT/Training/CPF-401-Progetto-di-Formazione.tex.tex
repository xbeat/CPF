...
\fancyhead[L]{CPF-401 Progetto di Formazione}
...
\hypersetup{
    ...
    citecolor=blue,
    urlcolor=blue,
    pdftitle={CPF-401 Progetto di Formazione},
    pdfauthor={Giuseppe Canale, CISSP}
}

\title{\textbf{CPF-401 Progetto di Formazione}\\
...
\textbf{Slide 5.1:} "Corrective Action Plan Requisiti" - CAP elements (addresses root cause, specific actions, timelines, responsibilities, verification approach, effectiveness measurement), review criteria, approval/conditional/rejection decisions.
...
\textbf{Slide 5.4:} "Verification Evidence Requisiti" - Types of evidence (objective evidence of implementation, multiple evidence types, proportionate to NC severity, demonstrates systemic change, temporal evidence), verification timing, evidence examples.
...
Module 5 & 5.1 & Corrective Action Plan Requisiti & Lecture & 15 min \\
Module 5 & 5.2 & CAP Examples Good vs Inadequate & Lecture & 15 min \\
Module 5 & 5.3 & Verification Methods & Lecture & 20 min \\
Module 5 & 5.4 & Verification Evidence Requisiti & Lecture & 15 min \\
...
\item CPF-27001:2025 - Sistema di Gestione della Vulnerabilità Psicologica Requisiti (complete standard)
...
\item CPF Schema di Certificazione - Professional certification requirements and pathways
...
\bibitem{cpf27001}
CPF-27001:2025, \textit{Sistema di Gestione della Vulnerabilità Psicologica - Requisiti}. CPF3 Organization.

\bibitem{iso27001}
ISO/IEC 27001:2022, \textit{Information security, cybersecurity and privacy protection - Information security management systems - Requisiti}. International Organization for Standardization.

\bibitem{iso17065}
ISO/IEC 17065:2012, \textit{Conformity assessment - Requisiti for bodies certifying products, processes and services}. International Organization for Standardization.
...
CPF3 (2025). \textit{CPF Schema di Certificazione Version 1.0}. CPF3 Organization.
...
\textbf{CPF-401: Audit Techniques Progetto di Formazione}
