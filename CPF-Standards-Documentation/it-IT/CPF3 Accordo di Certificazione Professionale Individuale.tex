...
\fancyhead[L]{CPF Accordo di Certificazione Individuale}
...
% Title
\title{\textbf{CPF ACCORDO DI CERTIFICAZIONE\\PROFESSIONALE INDIVIDUALE}}
\author{}
\date{}
...
Questo Accordo di Certificazione Professionale Individuale ("Accordo") è stipulato alla data di esecuzione da parte del Candidato ("Data di Efficacia"), tra:
...
CONSIDERATO CHE, il Candidato desidera ottenere la certificazione professionale nell'ambito dello Schema di Certificazione CPF;
...
\textbf{1.1 "Certificazione"} significa l'attestazione formale da parte dell'Organismo di Certificazione che il Candidato ha soddisfatto i requisiti per uno dei seguenti:
\begin{itemize}
...
\textbf{1.2 "Marchio di Certificazione"} significa il marchio commerciale, il logo e la designazione associati alla certificazione specifica concessa al Candidato.

\textbf{1.3 "CPF Code of Ethics"} significa gli standard di condotta professionale stabiliti per i professionisti certificati CPF, come possono essere modificati di volta in volta.

\textbf{1.4 "CPE"} significa i crediti di Continuing Professional Education richiesti per la ricertificazione.

\textbf{1.5 "Periodo di Certificazione"} significa il periodo di tre (3) anni dalla data di certificazione iniziale o ricertificazione.
...
Il Candidato sta applicando per la seguente certificazione (selezionare una):

\begin{itemize}
\item[$\square$] \textbf{CPF Certified Assessor}\\
Requisiti: Laurea triennale (Psicologia o Cybersecurity con formazione supplementare), 2 anni di esperienza, 80 ore di formazione (CPF-101 + CPF-201), esami scritti e pratici.

\item[$\square$] \textbf{CPF Certified Practitioner}\\
Requisiti: Laurea triennale in campo rilevante, 1 anno di esperienza nell'implementazione CPF, 40 ore di formazione (CPF-101), esame scritto e revisione del portfolio.

\item[$\square$] \textbf{CPF Certified Auditor}\\
Requisiti: Certificazione CPF Assessor corrente, 1 anno come Assessor, 10 valutazioni completate, 64 ore di formazione aggiuntiva (CPF-401 + ISO 19011), esami scritti e pratici.
\end{itemize}
...
\item Completare il modulo di domanda in modo accurato e veritiero;
\item Presentare tutta la documentazione richiesta incluso:
\begin{itemize}
...
\item Curriculum vitae attuale;
\item Documento di identità con foto rilasciato dal governo;
\end{itemize}
\item Pagare la quota di revisione della domanda non rimborsabile;
\item Fornire firma elettronica sul CPF Code of Ethics.
\end{enumerate}

\textbf{3.2 Revisione della Domanda.} L'Organismo di Certificazione deve:

\begin{enumerate}[label=\alph*)]
\item Revisionare la domanda per completezza ed eleggibilità;
\item Verificare le credenziali educative con le istituzioni che hanno rilasciato i titoli;
...
\item Verificare il completamento della formazione con i provider di formazione approvati;
\item Completare la revisione entro quindici (15) giorni lavorativi dalla ricezione della domanda completa;
\item Notificare al Candidato la determinazione di eleggibilità o richiedere informazioni aggiuntive.
\end{enumerate}
...
\textbf{3.4 Policy di Ripetizione.} Se il Candidato fallisce l'esame:

\begin{enumerate}[label=\alph*)]
\item Può ripetere dopo un periodo di attesa di trenta (30) giorni;
\item Massimo tre (3) tentativi entro dodici (12) mesi;
\item Ogni ripetizione richiede il pagamento della tariffa di ripetizione (50\% della tariffa dell'esame);
...
\item Emettere certificato e badge digitale dopo l'approvazione;
...
\begin{enumerate}[label=\alph*)]
\item Certificazione professionale nella categoria applicata;
...
\item Accesso ai benefici per i titolari di certificazione;
...
\item Mostrare il logo di certificazione su biglietti da visita, carta intestata, firme email e profili professionali;
...
\item Utilizzare il Marchio di Certificazione in modo che suggerisca la certificazione di prodotti, servizi o organizzazioni (a meno che non siano certificati separatamente);
...
\item Rappresentare che la certificazione si estende oltre la categoria specifica concessa.
\end{enumerate}
...
\item Accesso a risorse e strumenti esclusivi (se applicabile);
...
\item Praticare solo nelle aree di competenza dimostrata;
\item Proteggere la riservatezza dei dati di valutazione e delle informazioni dei clienti;
\item Mai utilizzare i dati di valutazione per profilazione individuale;
\item Implementare metodologie di preservazione della privacy in tutto il lavoro CPF;
...
\item Sottoporsi ad audit CPE se selezionato (10\% random annualmente);
\item Assicurare che i crediti CPE minimi sull'etica siano completati annualmente.
\end{enumerate}
...
\begin{itemize}
\item Condurre minimo cinque (5) valutazioni CPF durante il periodo di certificazione di 3 anni;
\item Partecipare alle attività di calibrazione degli assessor;
\item Presentare almeno un report di valutazione per peer review;
\item Mantenere conoscenza aggiornata degli aggiornamenti della metodologia CPF.
\end{itemize}

\textit{Per CPF Practitioner:}
\begin{itemize}
\item Mantenere portfolio aggiornato che dimostri applicazione pratica continua;
...
\item Presentare report di audit per quality review;
\item Partecipare alle attività di valutazione delle competenze degli auditor;
\item Mantenere indipendenza dalle attività di consulenza secondo ISO 19011.
\end{itemize}
...
\begin{enumerate}[label=\alph*)]
\item Cambiamenti nelle informazioni di contatto;
...
\item Fallimento o circostanze finanziarie che impattano la reputazione professionale;
\item Qualsiasi circostanza che possa impattare lo stato di certificazione o l'eleggibilità.
\end{enumerate}
...
\item Partecipare alle interviste se richiesto;
\item Non ritorcersi contro i reclamanti o i testimoni.
\end{enumerate}
...
\item Correggere prontamente qualsiasi travisamento quando scoperto.
\end{enumerate}

\section{RICERTIFICAZIONE}

\textbf{6.1 Requisito di Ricertificazione.} La certificazione scade tre (3) anni dalla data di emissione. Per mantenere la certificazione, il Professionista Certificato deve applicare per la ricertificazione.

\textbf{6.2 Processo di Ricertificazione.}

\begin{enumerate}[label=\alph*)]
\item L'Organismo di Certificazione invia avviso di ricertificazione 180 giorni prima della scadenza;
...
\item Lo stato di certificazione cambia in "Ricertificazione Pendente";
\item L'uso del Marchio di Certificazione è limitato durante il periodo di grazia;
\item Si applica una tariffa di ricertificazione tardiva (aggiuntivo \$100);
\item Dopo il periodo di grazia, è richiesto il processo di ricertificazione completo inclusi gli esami.
\end{enumerate}

\textbf{6.4 Rimedio del Deficit CPE.} Se i requisiti CPE non sono soddisfatti:

\begin{enumerate}[label=\alph*)]
\item Il Professionista Certificato può richiedere fino a 90 giorni di estensione per completare i CPE rimanenti;
\item L'estensione è concessa a discrezione dell'Organismo di Certificazione;
\item Lo stato di certificazione cambia in "Condizionale" durante l'estensione;
\item Se i CPE non sono completati entro l'estensione, la certificazione decade;
\item Può applicarsi una tariffa di estensione.
\end{enumerate}
...
\item Tariffa di Ripetizione: 50\% della tariffa dell'esame originale
\end{itemize}
...
\begin{itemize}
\item Richiesta di Estensione CPE: \$50
...
\item Tariffe non rimborsabili eccetto come specificamente indicato;
\item Servizi non forniti fino alla ricezione del pagamento;
\item Le tariffe in arretrato possono risultare nella sospensione della certificazione.
\end{enumerate}
...
\begin{enumerate}[label=\alph*)]
\item Avviso scritto di sospensione con motivi specifici;
\item Cessazione immediata dell'uso del Marchio di Certificazione;
\item Stato nel registro cambiato in "Sospeso";
\item Periodo di sospensione: Massimo 90 giorni;
\item Piano di rimedio richiesto entro 30 giorni;
\item Reintegrazione al completamento con successo del rimedio;
\item Se non rimediato entro 90 giorni: Avviati i procedimenti di revoca.
\end{enumerate}

\textbf{8.3 Motivi di Revoca.} L'Organismo di Certificazione può revocare la certificazione per:

\begin{enumerate}[label=\alph*)]
\item Violazioni etiche gravi incluso:
\begin{itemize}
\item Frode, dichiarazione falsa o disonestà;
\item Violazione della riservatezza o uso improprio dei dati;
\item Profilazione individuale utilizzando dati di valutazione;
...
\item Violazione materiale di questo Accordo.
\end{enumerate}

\textbf{8.4 Processo di Revoca.}

\begin{enumerate}[label=\alph*)]
\item Avviso scritto di intento di revocare con motivi specifici;
...
\textbf{8.5 Resa Volontaria.} Il Professionista Certificato può rendere volontariamente la certificazione tramite:

\begin{enumerate}[label=\alph*)]
\item Avviso scritto all'Organismo di Certificazione;
\item Cessazione immediata dell'uso del Marchio di Certificazione;
...
\item Fallimento dell'esame dovuto a irregolarità procedurali (non punteggio);
\item Diniego della ricertificazione;
...
\item Pannello di appelli indipendente assegnato (nessun coinvolgimento nella decisione originale);
\item Il pannello revisiona tutte le evidenze e la logica della decisione;
\item L'appellante può fornire informazioni scritte aggiuntive;
\item Il pannello emette la decisione entro 30 giorni;
\item Opzioni di decisione: Confermare, Modificare, Annullare, o Rinviare per riconsiderazione;
\item Tariffa rimborsata se l'appello ha successo;
\item La decisione del pannello di appelli è finale e vincolante.
\end{enumerate}

\textbf{9.3 Composizione del Pannello di Appelli.}

\begin{itemize}
\item Tre membri: un professionista CPF certificato, un esperto in materia, un rappresentante dell'Organismo di Certificazione non coinvolto nella decisione originale;
\item I membri del pannello non hanno conflitto di interessi;
...
\textbf{10.2 Diritti di Protezione dei Dati.} Il Professionista Certificato ha diritto di:
...
\item Mantenere tracce di audit per l'accesso ai dati e le modifiche.
\end{enumerate}
...
\item La notifica include la natura della violazione, i dati interessati e i passi di mitigazione;
...
\textbf{11.1 Esclusione di Garanzie.} L'ORGANISMO DI CERTIFICAZIONE NON FORNISCE GARANZIE, ESPLICITE O IMPLICITE, RIGUARDO AI RISULTATI DELLA CERTIFICAZIONE, BENEFICI DI CARRIERA O POTENZIALE DI REDDITO. LA CERTIFICAZIONE È FORNITA "COSÌ COM'È" SENZA GARANZIA DI COMMERCIABILITÀ O IDONEITÀ PER UNO SCOPO PARTICOLARE.

\textbf{11.2 Limitazione dei Danni.} IN NESSUN CASO L'ORGANISMO DI CERTIFICAZIONE SARÀ RESPONSABILE PER DANNI INDIRETTI, INCIDENTALI, CONSEQUENZIALI, SPECIALI, ESEMPLARI O PUNITIVI, INCLUSO REDDITO PERSO, OPPORTUNITÀ DI BUSINESS PERSE O DANNO REPUTAZIONALE, DERIVANTI DALLA CERTIFICAZIONE O DAL SUO DINIEGO.

\textbf{11.3 Limite Massimo di Responsabilità.} LA RESPONSABILITÀ TOTALE DELL'ORGANISMO DI CERTIFICAZIONE AI SENSI DI QUESTO ACCORDO NON SUPERERÀ LE TARIFFE TOTALI PAGATE DAL PROFESSIONISTA CERTIFICATO NEI DODICI (12) MESI PRECEDENTI IL RECLAMO.

\textbf{11.4 Eccezioni.} Le limitazioni non si applicano a:

\begin{enumerate}[label=\alph*)]
\item Negligenza grave o condotta intenzionale dell'Organismo di Certificazione;
\item Violazioni degli obblighi di riservatezza;
\item Violazioni della protezione dei dati;
\item Reclami non permessi di limitare ai sensi della legge applicabile.
\end{enumerate}
...
\item Violazione di questo Accordo o del CPF Code of Ethics da parte del Professionista Certificato;
...
\item Evidenza dell'assicurazione fornita ai clienti su richiesta;
...
\textbf{13.1 Legge Applicabile.} Questo Accordo sarà governato dalle leggi di [Giurisdizione], senza riguardo ai principi di conflitto di leggi.
...
\item Le controversie non risolte attraverso la negoziazione o il processo di appelli saranno risolte attraverso arbitrato vincolante;
...
\item Ogni parte sostiene i propri costi a meno che l'arbitro non determini diversamente.
\end{enumerate}

\textbf{13.3 Accordo Completo.} Questo Accordo, inclusi il CPF Code of Ethics e i requisiti dello Schema di Certificazione incorporati, costituisce l'intero accordo e sostituisce tutte le intese precedenti.

\textbf{13.4 Modifica.} L'Organismo di Certificazione può modificare questo Accordo o il CPF Code of Ethics fornendo 90 giorni di preavviso scritto. La certificazione continuata dopo la data di efficacia costituisce accettazione. Se il Professionista Certificato non accetta le modifiche, può rendere volontariamente la certificazione.

\textbf{13.5 Cessione.} Il Professionista Certificato non può cedere o trasferire la certificazione. L'Organismo di Certificazione può cedere questo Accordo in connessione con trasferimento di attività o fusione.

\textbf{13.6 Comunicazioni.} Tutte le comunicazioni devono essere inviate agli indirizzi dichiarati sopra o come aggiornato per iscritto. L'email con conferma di ricezione è accettabile per le comunicazioni di routine.

\textbf{13.7 Separabilità.} Se qualsiasi disposizione risulta invalida, le disposizioni rimanenti continuano in pieno effetto.

\textbf{13.8 Rinuncia.} Il mancato esercizio di qualsiasi disposizione non costituisce rinuncia al diritto di esercitarla successivamente.
...
Firmando sotto, il Candidato riconosce e accetta che:

\begin{enumerate}[label=\alph*)]
\item Ha letto e compreso questo Accordo nella sua interezza;
\item Ha letto e accetta di conformarsi al CPF Code of Ethics;
\item Ha fornito informazioni accurate e veritiere nella domanda;
\item Comprende i requisiti di certificazione e gli obblighi continui;
...
\item Autorizza la pubblicazione del nome e dello stato di certificazione nel registro pubblico;
...
\section*{REGISTRO DI CERTIFICAZIONE (Solo per Uso OC)}
